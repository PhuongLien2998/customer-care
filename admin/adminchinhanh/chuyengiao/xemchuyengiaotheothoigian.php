<?php  
    ...
    FROM tbl_nhanvien,
        ...
        WHERE tbl_lichsudieuchuyen.id_khachhang=tbl_khachhang.id_khachhang AND tbl_lichsudieuchuyen.id_nhanvienchuyen=tbl_nhanvien.id_nhanvien AND tbl_lichsudieuchuyen.thoigianchuyen BETWEEN '$ngaybd' AND '$ngaykt'  )as X
