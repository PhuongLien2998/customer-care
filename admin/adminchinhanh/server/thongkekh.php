<?php  
    ...
    WHERE tbl_hoadon.id_hoadon=tbl_hoadonchitiet.id_hoadon AND tbl_hoadonchitiet.id_hdct=tien.id_hdct AND tbl_hoadon.id_nhanvienbh=tbl_nhanvien.id_nhanvien AND tbl_nhanvien.id_chinhanh=tbl_chinhanh.id_chinhanh AND tbl_hoadon.id_khachhang=tbl_khachhang.id_khachhang AND tbl_chinhanh.id_chinhanh='$id_cn' AND tbl_hoadon.thoigianthanhtoan BETWEEN '$ngaybd' AND '$ngaykt' 
