...
$(document).ready(function(){
	...
	$(document).on('click', '.timkiem',function(){
		...
		if(checkNgaybd()&&checkNgaykt()){
			...
			$.post("server/thongkekh.php", {ngaybd : ngaybd, ngaykt : ngaykt ,chinhanh:chinhanh}, function(data){
				$("#right").html(data);
	...
	$(document).on('click', '#view_hd',function(){
		...
		var chinhanh = $('.select').val();
		var id = $(this).val();
		console.log(ngaybd,ngaykt,chinhanh,id);
	
		
	
			$.post("server/view_hd.php", {id : id,ngaybd : ngaybd, ngaykt : ngaykt ,chinhanh:chinhanh}, function(data){
				$("#show-hd").html(data);
	...
	$(document).on('click', '#view_hdct',function(){
		...
		var id = $(this).val();
			...
			$.post("server/view_hdct.php", {id : id,ngaybd : ngaybd, ngaykt : ngaykt ,chinhanh:chinhanh}, function(data){
				$("#show-hd").html(data);
