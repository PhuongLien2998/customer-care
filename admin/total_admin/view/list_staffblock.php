...
FROM
    ...
    tbl_taikhoan
WHERE
    tbl_nhanvien.id_chinhanh = tbl_chinhanh.id_chinhanh AND tbl_nhanvien.id_nhanvien = tbl_taikhoan.id_nv AND tbl_taikhoan.status = 0 AND( tbl_taikhoan.level = 2 OR tbl_taikhoan.level = 4)
			...
			<div class="container" >
				<div class="row" style="margin-top: 20px">
					...
					<!-- search -->		
          			...
          			<input type="tel" id="search_block" class="form-control inp-day" placeholder="Nhập tên nhân viên cần tìm" >
