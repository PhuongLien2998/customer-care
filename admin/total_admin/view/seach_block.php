<?php  
    ...
    WHERE tbl_taikhoan.id_nv=tbl_nhanvien.id_nhanvien ANd tbl_nhanvien.id_chinhanh=tbl_chinhanh.id_chinhanh AND  tbl_nhanvien.ten_nhanvien LIKE'%$name%' AND tbl_taikhoan.status=0 AND ( level = 2 OR level = 4 )";
