...
<div class="container">
    ...
    $id_nhanvienchuyen = $_SESSION['id_nv'];
    ...
    if (isset($_POST["confirm"])) {
        ...
        if ($count_error == 0) {
            ...
            if ($query) {
                $_SESSION['noti'] = "Chuyển khách hàng thành công, chờ xác nhận!" ;
                echo "<script>
                         window.location=\" index.php?page=list-customer \";
                        </script>";
            }
        }
    }
        ...
        <div class="col-md-9">
            ...
            <form action="" method="POST">
                <div class="form-group">
                    ...
                    <datalist id="brow">
                        <?php
                        $sql_nv = "SELECT ten_nhanvien , id_nhanvien FROM tbl_nhanvien , tbl_taikhoan 
                        WHERE id_nv = id_nhanvien AND level =2 ;";
